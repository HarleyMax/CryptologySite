...
function XorOutput() {
    ...
    for(let i = 0; i < message.length; i++) {
        if(message.charAt(i) != '1' &&  message.charAt(i) != '0'){
            answer = "One of the numbers you gave was not a binary number!"
            break;
        }
        else if(key.charAt(i) != '1' &&  key.charAt(i) != '0'){
            message = "One of the numbers you gave was not a binary number!"
            break;
        }
        else if(message.charAt(i) == '0' && key.charAt(i) == '1') {
            answer += '1';
        }
        else if(message.charAt(i) == '1' && key.charAt(i) == '0') {
            answer += '1';
        } 
        else{
            answer += '0';
